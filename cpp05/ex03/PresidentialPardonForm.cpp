...
/*   Updated: 2025/09/28 16:06:05 by lolelsay         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//Default constructor
PresidentialPardonForm::PresidentialPardonForm(void) : AForm("Presidential Pardon", TO_EXEC_GRADE, TO_SIGN_GRADE),  _target("Nowhere") {}

//Name assignation constructor
PresidentialPardonForm::PresidentialPardonForm(std::string target) : AForm("Presidential Pardon", TO_EXEC_GRADE, TO_SIGN_GRADE), _target(target) {}
