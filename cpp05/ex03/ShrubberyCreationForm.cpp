...
//Default constructor
ShrubberyCreationForm::ShrubberyCreationForm(void) :  AForm("Shrubbery Creation", TO_EXEC_GRADE, TO_SIGN_GRADE), _target("Nowhere") {}

//Name assignation constructor
ShrubberyCreationForm::ShrubberyCreationForm(std::string target) : AForm("Shrubbery Creation", TO_EXEC_GRADE, TO_SIGN_GRADE), _target(target){}
