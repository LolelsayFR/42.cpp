...
//Default constructor
RobotomyRequestForm::RobotomyRequestForm(void) : AForm("RobotomyRequestForm", TO_EXEC_GRADE, TO_SIGN_GRADE),  _target("Nowhere") {}

//Name assignation constructor
RobotomyRequestForm::RobotomyRequestForm(std::string target) : AForm("RobotomyRequestForm", TO_EXEC_GRADE, TO_SIGN_GRADE), _target(target) {}
